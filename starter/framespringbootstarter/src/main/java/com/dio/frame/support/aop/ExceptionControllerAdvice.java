package com.dio.frame.support.aop;

import com.dio.frame.support.domain.Result;
import com.dio.frame.support.exception.DioException;
...
public class ExceptionControllerAdvice {
	 ...
	 * @return
	 */
	@ExceptionHandler(value = { Exception.class, RuntimeException.class, DioException.class})
